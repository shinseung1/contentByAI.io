  ...
  return (
    <div>
      <div className="page-header">
        <Title level={1}>
          <ExperimentOutlined /> Claude 콘텐츠 생성
        </Title>
        <Text type="secondary">Anthropic의 Claude AI를 사용하여 고품질의 분석적 콘텐츠를 생성합니다</Text>
      </div>
      ...
      <Card 
        title={
          <Space>
            <ExperimentOutlined style={{ color: '#8B5A2B' }} />
            새로운 콘텐츠 생성
          </Space>
        }
        style={{ marginTop: 24 }}
      >
        ...
        >
          ...
          >
            <TextArea
              rows={3}
              placeholder="Claude AI로 생성할 콘텐츠의 주제를 구체적으로 입력해주세요. 예: '인공지능 윤리와 사회적 책임에 대한 분석적 고찰'"
            />
          </Form.Item>
            ...
            <Col span={12}>
              <Form.Item name="tone" label="톤 앤 매너">
                <Select>
                  ...
                  <Select.Option value="thoughtful">사려깊은</Select.Option>
                  <Select.Option value="conversational">대화형</Select.Option>
                  <Select.Option value="explanatory">설명적</Select.Option>
                </Select>
              </Form.Item>
            </Col>
            <Col span={12}>
      ...
      <Card 
        title={
          <Space>
            <HistoryOutlined style={{ color: '#8B5A2B' }} />
            Claude 생성 히스토리
          </Space>
        }
        style={{ marginTop: 24 }}
